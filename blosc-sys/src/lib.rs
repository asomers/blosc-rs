...
pub const BLOSC_VERSION_MINOR: u32 = 13;
pub const BLOSC_VERSION_RELEASE: u32 = 1;
pub const BLOSC_VERSION_STRING: &'static [u8; 7usize] = b"1.13.1\0";
pub const BLOSC_VERSION_REVISION: &'static [u8; 6usize] = b"$Rev$\0";
pub const BLOSC_VERSION_DATE: &'static [u8; 22usize] = b"$Date:: 2018-01-13 #$\0";
...
extern "C" {
    ...
    pub fn blosc_get_compressor() -> *mut ::std::os::raw::c_char;
}
extern "C" {
...
extern "C" {
    ...
    pub fn blosc_compcode_to_compname(
        ...
        compname: *mut *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    ...
    pub fn blosc_list_compressors() -> *mut ::std::os::raw::c_char;
}
extern "C" {
    /// Return the version of blosc in string format.
    ///
    /// Useful for dynamic libraries.
    pub fn blosc_get_version_string() -> *mut ::std::os::raw::c_char;
}
extern "C" {
    ...
    pub fn blosc_get_complib_info(
        compname: *mut ::std::os::raw::c_char,
